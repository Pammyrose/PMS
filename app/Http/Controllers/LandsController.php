...
class LandsController extends Controller
{
    ...
    public function index(Request $request, $program = null)
    {
        ...
        $programsRaw = $this->getLandsPrograms($programId, $search)
        ...
        return view('admin.lands.lands_physical', compact(
            'entries',
            'programs',
            'programsRaw',
            'existing',
    ...
    public function overview()
    {
        ...
        $programs = $grouped;
        return view('admin.lands.lands_physical', compact('programs', 'offices'));
    }
...
private function getLandsPrograms(?int $programId = null, string $search = ''): Collection
{
    $recordTypeIds = $this->getLandsRecordTypeIds();
    $typeId = $this->getLandsTypeId();
