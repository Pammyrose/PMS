...
class NraController extends Controller
{
    ...
    public function index(Request $request, $program = null)
    {
        ...
        $programsRaw = $this->getNraPrograms($programId, $search)
        ...
        return view('admin.nra.nra_physical', compact(
            'entries',
            'programs',
            'programsRaw',
            'existing',
    ...
    public function overview()
    {
        ...
        $programs = $grouped;
        return view('admin.nra.nra_physical', compact('programs', 'offices'));
    }
...
private function getNraPrograms(?int $programId = null, string $search = ''): Collection
{
    $recordTypeIds = $this->getNraRecordTypeIds();
    $typeId = $this->getNraTypeId();
