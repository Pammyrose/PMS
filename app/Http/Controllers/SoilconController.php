...
class SoilconController extends Controller
{
    ...
    public function index(Request $request, $program = null)
    {
        ...
        $programsRaw = $this->getSoilconPrograms($programId, $search)
        ...
        return view('admin.soilcon.soilcon_physical', compact(
            'entries',
            'programs',
            'programsRaw',
            'existing',
    ...
    public function overview()
    {
        ...
        $programs = $grouped;
        return view('admin.soilcon.soilcon_physical', compact('programs', 'offices'));
    }
...
private function getSoilconPrograms(?int $programId = null, string $search = ''): Collection
{
    $recordTypeIds = $this->getSoilconRecordTypeIds();
    $typeId = $this->getSoilconTypeId();
