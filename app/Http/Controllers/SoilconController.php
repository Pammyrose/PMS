...
class SoilconController extends Controller
{
    ...
    public function overview()
    {
        ...
        $programs = $grouped;
        return view('admin.soilcon.soilcon', compact('programs', 'offices'));
    }
    ...
    public function save(Request $request)
    {
        ...
        $redirectRoute = $firstProgramId 
            ? route('admin.soilcon_physical.physical', $firstProgramId)
            : route('admin.soilcon_physical.physical');
