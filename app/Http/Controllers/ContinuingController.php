...
class ContinuingController extends Controller
{
    ...
    public function index(Request $request, $program = null)
    {
        ...
        $programsRaw = $this->getContinuingPrograms($programId, $search)
    ...
    public function overview()
    {
        ...
        $programs = $grouped;
        return view('admin.continuing.continuing_physical', compact('programs', 'offices'));
    }
...
private function getContinuingPrograms(?int $programId = null, string $search = ''): Collection
{
    $recordTypeIds = $this->getContinuingRecordTypeIds();
    $typeId = $this->getContinuingTypeId();
