...
class PariaController extends Controller
{
    ...
    public function index(Request $request, $program = null)
    {
        ...
        $programsRaw = $this->getPariaPrograms($programId, $search)
        ...
        return view('admin.paria.paria_physical', compact(
            'entries',
            'programs',
            'programsRaw',
            'existing',
    ...
    public function overview()
    {
        ...
        $programs = $grouped;
        return view('admin.paria.paria_physical', compact('programs', 'offices'));
    }
...
private function getPariaPrograms(?int $programId = null, string $search = ''): Collection
{
    $recordTypeIds = $this->getPariaRecordTypeIds();
    $typeId = $this->getPariaTypeId();
