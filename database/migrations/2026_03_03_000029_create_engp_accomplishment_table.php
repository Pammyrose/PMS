...
return new class extends Migration
{
    ...
    {
        Schema::create('engp_accomplishment', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->nullable()->constrained('users')->nullOnDelete();
            $table->foreignId('office_id')->nullable()->constrained('offices')->nullOnDelete();
            $table->foreignId('program_id')->constrained('engp_pap')->cascadeOnDelete();
            $table->foreignId('indicator_id')->constrained('engp_indicators')->cascadeOnDelete();
            ...
            $table->unique(['indicator_id', 'year', 'office_id'], 'engp_accomp_indicator_year_office_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('engp_accomplishment');
    }
};
