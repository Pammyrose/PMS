...
Route::get('/gass_physical', [GassController::class, 'index'])->middleware(['auth', $viewRoles])->name('gass_physical');
Route::get('/sto', [StoController::class, 'index'])->middleware(['auth', $viewRoles])->name('sto');
Route::get('/sto_physical', [StoController::class, 'index'])->middleware(['auth', $viewRoles])->name('sto_physical');
Route::get('/enf', [EnfController::class, 'index'])->middleware(['auth', $viewRoles])->name('enf');
Route::get('/enf_physical', [EnfController::class, 'index'])->middleware(['auth', $viewRoles])->name('enf_physical');
Route::get('/pa', [PaController::class, 'index'])->middleware(['auth', $viewRoles])->name('pa');
Route::get('/pa_physical', [PaController::class, 'index'])->middleware(['auth', $viewRoles])->name('pa_physical');
Route::get('/engp', [EngpController::class, 'index'])->middleware(['auth', $viewRoles])->name('engp');
Route::get('/engp_physical', [EngpController::class, 'index'])->middleware(['auth', $viewRoles])->name('engp_physical');
Route::get('/lands', [LandsController::class, 'index'])->middleware(['auth', $viewRoles])->name('lands');
Route::get('/lands_physical', [LandsController::class, 'index'])->middleware(['auth', $viewRoles])->name('lands_physical');
Route::get('/soilcon', [SoilconController::class, 'index'])->middleware(['auth', $viewRoles])->name('soilcon');
Route::get('/soilcon_physical', [SoilconController::class, 'index'])->middleware(['auth', $viewRoles])->name('soilcon_physical');
Route::get('/nra', [NraController::class, 'index'])->middleware(['auth', $viewRoles])->name('nra');
Route::get('/nra_physical', [NraController::class, 'index'])->middleware(['auth', $viewRoles])->name('nra_physical');
Route::get('/paria', [PariaController::class, 'index'])->middleware(['auth', $viewRoles])->name('paria');
Route::get('/paria_physical', [PariaController::class, 'index'])->middleware(['auth', $viewRoles])->name('paria_physical');
Route::get('/cobb', [CobbController::class, 'index'])->middleware(['auth', $viewRoles])->name('cobb');
Route::get('/cobb_physical', [CobbController::class, 'index'])->middleware(['auth', $viewRoles])->name('cobb_physical');
Route::get('/continuing', [ContinuingController::class, 'index'])->middleware(['auth', $viewRoles])->name('continuing');
Route::get('/continuing_physical', [ContinuingController::class, 'index'])->middleware(['auth', $viewRoles])->name('continuing_physical');
...
foreach ($userPhysicalSaveControllers as $physicalKey => $controllerClass) {
    Route::prefix($physicalKey . '_physical')
        ...
        ->group(function () use ($controllerClass) {
            Route::post('/targets/store', [$controllerClass, 'storeTargets'])->name('targets.store');
            Route::post('/accomplishments/store', [$controllerClass, 'storeAccomplishments'])->name('accomplishments.store');
        });
}
