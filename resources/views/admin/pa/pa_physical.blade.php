...
<head>
    ...
    <title>Physical Performance (PA) - PMS</title>

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/admin/pa/pa_physical.css') }}">
</head>
...
<body class="bg-light">
    ...
    <div class="d-flex">
        ...
        <main class="flex-grow-1 p-3">
            ...
            @include('admin.pa.partials.pa_physical_header')
                    ...
                    <div class="table-container">
                        <table class="text-sm" id="performanceTable">
                            ...
                            <tbody class="text-gray-800">
                                @include('admin.pa.partials.pa_physical_table_rows')
                            </tbody>
                        </table>
                    </div>
                </div>
    ...
    <div class="modal fade" id="addIndicatorModal" tabindex="-1" aria-labelledby="addIndicatorModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content border-0 shadow-lg">
                ...
                <form id="addIndicatorForm" method="POST" action="{{ route('admin.pa_physical.indicators.store') }}"
                    data-update-route-template="{{ route('admin.pa_physical.indicators.update', ':id') }}"
                    data-delete-route-template="{{ route('admin.pa_physical.indicators.destroy', ':id') }}">
                    @csrf
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="text" id="pap_subsubactivities" class="form-control form-control-sm py-2"
                                        style="font-size: 0.875rem;" list="pap_subsubactivity_options">
    ...
    <script>
        ...
        document.getElementById('addIndicatorForm')?.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                if (!programId) {
                    ...
                    const papResponse = await fetch(@json(route('admin.pa_physical.pap.store')), {
                        method: 'POST',
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest',
                            'X-CSRF-TOKEN': token,
        ...
        const addIndicatorModalElement = document.getElementById('addIndicatorModal');
        addIndicatorModalElement?.addEventListener('show.bs.modal', function () {
            resetPapLevels();
        });
