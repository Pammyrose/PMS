...
<body class="bg-light">
        ...
        <main class="flex-grow-1 p-3">
            ...
            <div class="bg-white rounded shadow p-3">
                ...
                @include('admin.enf.partials.enf_physical_toolbar')
                    ...
                    @include('admin.enf.partials.enf_physical_table')
                </div>
    ...
    @include('admin.enf.partials.enf_physical_main_scripts')

    @include('admin.enf.partials.enf_physical_main_scripts2')

    @include('components.physical_highlight_script')

    @include('admin.enf.partials.enf_physical_modals')

    @include('admin.enf.partials.enf_physical_modal_scripts')
