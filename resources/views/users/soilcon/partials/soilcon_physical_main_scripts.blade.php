    ...
    <script>
        ...
        const targetSoilconreUrl = @json(route('users.soilcon_physical.targets.store'));
        const accompSoilconreUrl = @json(route('users.soilcon_physical.accomplishments.store'));
        const deletePhysicalRowUrl = @json(route('admin.soilcon_physical.rows.destroy'));
        ...
        function buildMonthlyMapFromSoilconred(sourceData) {
        ...
        function refreshSummaryCards() {
            const targetMap = buildMonthlyMapFromSoilconred(existingTargetsByIndicator);
            const accompMap = buildMonthlyMapFromSoilconred(existingAccompByIndicator);
        ...
        function updateSummaryInputsForRow(row) {
            ...
            summaryInputs.forEach(input => {
                ...
                if (!Number.isFinite(value)) {
                    value = getSoilconredValueForSummary(sectionType, programId, indicatorId, officeId, periodKey);
                }
        ...
        function getSoilconredValueForSummary(sectionType, programId, indicatorId, officeId, periodKey) {
