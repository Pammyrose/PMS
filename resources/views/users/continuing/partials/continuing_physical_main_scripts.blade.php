    ...
    <script>
        ...
        const targetContinuingreUrl = @json(route('users.continuing_physical.targets.store'));
        const accompContinuingreUrl = @json(route('users.continuing_physical.accomplishments.store'));
        ...
        function buildMonthlyMapFromContinuingred(sourceData) {
        ...
        function refreshSummaryCards() {
            const targetMap = buildMonthlyMapFromContinuingred(existingTargetsByIndicator);
            const accompMap = buildMonthlyMapFromContinuingred(existingAccompByIndicator);
        ...
        function updateSummaryInputsForRow(row) {
            ...
            summaryInputs.forEach(input => {
                ...
                if (!Number.isFinite(value)) {
                    value = getContinuingredValueForSummary(sectionType, programId, indicatorId, officeId, periodKey);
                }
        ...
        function getContinuingredValueForSummary(sectionType, programId, indicatorId, officeId, periodKey) {
        ...
        function getContinuingredEntryByOffice(sourceByIndicator, programId, indicatorId, officeId) {
        ...
        function hasEntryChanged(sectionType, entry) {
            ...
            const sourceByIndicator = sectionType === 'target'
                ? existingTargetsByIndicator
                : existingAccompByIndicator;
            const storedEntry = getContinuingredEntryByOffice(sourceByIndicator, rowId, indicatorId, officeId);
        ...
        async function saveSectionEntries(sectionType, options = {}) {
            ...
            const url = isTarget ? targetContinuingreUrl : accompContinuingreUrl;
