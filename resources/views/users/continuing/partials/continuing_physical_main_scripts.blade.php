    ...
    <script>
        ...
        const targetStoreUrl = @json(route('users.continuing_physical.targets.store'));
        const accompStoreUrl = @json(route('users.continuing_physical.accomplishments.store'));
