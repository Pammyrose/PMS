    ...
    <script>
        ...
        const targetLandsreUrl = @json(route('users.lands_physical.targets.store'));
        const accompLandsreUrl = @json(route('users.lands_physical.accomplishments.store'));
        const deletePhysicalRowUrl = @json(route('admin.lands_physical.rows.destroy'));
        ...
        function buildMonthlyMapFromLandsred(sourceData) {
        ...
        function refreshSummaryCards() {
            const targetMap = buildMonthlyMapFromLandsred(existingTargetsByIndicator);
            const accompMap = buildMonthlyMapFromLandsred(existingAccompByIndicator);
        ...
        function updateSummaryInputsForRow(row) {
            ...
            summaryInputs.forEach(input => {
                ...
                if (!Number.isFinite(value)) {
                    value = getLandsredValueForSummary(sectionType, programId, indicatorId, officeId, periodKey);
                }
        ...
        function getLandsredValueForSummary(sectionType, programId, indicatorId, officeId, periodKey) {
