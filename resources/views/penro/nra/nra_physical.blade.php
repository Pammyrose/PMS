...
<body class="bg-light">
    ...
    <div class="d-flex">
        ...
        <main class="flex-grow-1 p-3">
            ...
            @include('penro.nra.partials.nra_physical_header')
            ...
            <div class="bg-white rounded shadow p-3">
                @include('penro.nra.partials.nra_physical_tabs')
                @include('penro.nra.partials.nra_physical_toolbar')

                    @include('penro.nra.partials.nra_physical_table')
                </div>
    ...
    @include('penro.nra.partials.nra_physical_main_scripts')

    @include('penro.nra.partials.nra_physical_main_scripts2')

    @include('components.physical_highlight_script')

    @include('penro.nra.partials.nra_physical_modals')

    @include('penro.nra.partials.nra_physical_modal_scripts')
