    ...
    <div class="modal fade" id="gassExcelPreviewModal" tabindex="-1" aria-labelledby="gassExcelPreviewModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-fullscreen-xl-down modal-xl modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-success text-white">
                    <div>
                        <h5 class="modal-title" id="gassExcelPreviewModalLabel">Excel Import Preview</h5>
                        <div class="small opacity-75" id="gassExcelPreviewSubtitle">Review parsed sorting before import.</div>
                    </div>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="gassExcelPreviewLoading" class="text-center py-5">
                        <div class="spinner-border text-success" role="status"></div>
                        <div class="fw-semibold mt-3">Reading Excel file...</div>
                    </div>

                    <div id="gassExcelPreviewContent" class="d-none">
                        <div class="row g-2 mb-3" id="gassExcelPreviewStats"></div>

                        <div id="gassExcelPreviewWarningPanel" class="alert alert-warning d-none" role="alert">
                            <div class="fw-bold mb-2">
                                <i class="fa fa-triangle-exclamation me-1"></i> Sorting warnings
                            </div>
                            <ul class="mb-0 ps-3" id="gassExcelPreviewWarnings"></ul>
                        </div>

                        <div class="table-responsive gass-preview-table-wrap">
                            <table class="table table-sm align-middle mb-0 gass-preview-table">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="gassExcelPreviewRows"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light">
                    ...
                    <button type="button" class="btn btn-success" id="gassExcelConfirmImportBtn" disabled>
