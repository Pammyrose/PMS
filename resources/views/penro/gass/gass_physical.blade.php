...
<body class="bg-light">
    ...
    <div class="d-flex">
        ...
        <main class="flex-grow-1 p-3">
            ...
            @include('penro.gass.partials.gass_physical_header')
            ...
            <div class="bg-white rounded shadow p-3">
                @include('penro.gass.partials.gass_physical_tabs')
                @include('penro.gass.partials.gass_physical_toolbar')

                    @include('penro.gass.partials.gass_physical_table')
                </div>
    ...
    @include('penro.gass.partials.gass_physical_main_scripts')

    @include('penro.gass.partials.gass_physical_main_scripts2')

    @include('components.physical_highlight_script')

    @include('penro.gass.partials.gass_physical_modals')

    @include('penro.gass.partials.gass_physical_modal_scripts')
