    ...
    <script>
        ...
        const targetSoilconreUrl = @json(route('admin.soilcon_physical.targets.store'));
        const accompSoilconreUrl = @json(route('admin.soilcon_physical.accomplishments.store'));
