    ...
    <script>
        ...
        const targetContinuingreUrl = @json(route('admin.continuing_physical.targets.store'));
        const accompContinuingreUrl = @json(route('admin.continuing_physical.accomplishments.store'));
